	...
	<div class="page" id="tablewrapper">
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
		 ...
		 if($_SESSION['level']=="admin" || $_SESSION['level']=="tu"){
			echo "
			<a href=edit_siswa.php?nis=$baris[idSiswa]><img src=icon/update.png border=0></a>&nbsp;|
			<a href=hapus_siswa.php?nis=$baris[idSiswa] onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data?')\"><img src=icon/hapus.png border=0></a></td>
            </tr>";
			}}
			?>
            </tbody>
