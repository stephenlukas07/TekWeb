	...
	<div id="tablewrapper">
        ...
        <table width="709" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
		 ...
		 if($_SESSION['level']=="admin" || $_SESSION['level']=="tu"){
			echo "
			<td><a href=edit_mapel.php?id=$baris[idmata_pelajaran]><img src=icon/update.png border=0></a>&nbsp;|
			<a href=hapus_mapel.php?id=$baris[idmata_pelajaran] onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data?')\"><img src=icon/hapus.png border=0></a></td>
            </tr>";
			} }
			?>
            </tbody>
