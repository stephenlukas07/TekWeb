	...
	<div class="page" id="tablewrapper">
        ...
        <table width="1001" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
		 ...
		 if($_SESSION['level']=="admin" || $_SESSION['level']=="tu"){
			echo "<a href=edit_nilai.php?nis=$nilai[idSiswa]&pelajaran=$nilai[idmata_pelajaran]&semester=$nilai[semester]&tahun=$nilai[thn_ajaran]&kelas=$kls><img src=icon/update.png border=0></a>&nbsp;|
